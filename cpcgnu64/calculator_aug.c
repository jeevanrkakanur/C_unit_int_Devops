...
/*   Execution date : 2026-03-22 16:57:42 */
/*   Cmd line : "attolcc4" "cpcgnu64\calculator.i" "cpcgnu64\calculator_aug.c" "atus_c.def" "atl.opp" "-noinstrdir=D:\Program Files\HCL\TDPS2\cpcgnu64" "-nopath" "-proc=ret" "-block=logical" "-trace" "-mempro" "-perfpro" "-call" "-cond" "-StackSize" "-SET=MINMAX" "-studio_log=D:\HCL_GIT_DEVOPS\Demo_GIT\intermediates_files830192050.log" */
...
_ATC_DECLARE_PROC(1,6)
_ATC_DECLARE_BLOC(1,3)
_ATC_DECLARE(1,0x497A6A0AUL,0x9260813UL,6,_ATC_TAB_PROC(1),0,0,3,_ATC_TAB_BLOC(1),0,0)

_ATL_STACK_DECLARE(1,0x497A6A0AUL,0x4D52251BUL)
...
int subtract(int a, int b) {_ATC_LINK(1);{_ATC_PROC_IN(1,3);{_ATC_BLOC(1,1);{_ATL_STACK_IN(1,2) _ATZ_IN(1)_ATQ_IN(1)_ATP_IN(1){_ATT_IN(1){
 ...
 int multiply(int a, int b) {_ATC_LINK(1);{_ATC_PROC_IN(1,5);{_ATC_BLOC(1,2);{_ATL_STACK_IN(1,3) _ATZ_IN(1)_ATQ_IN(1)_ATP_IN(1){_ATT_IN(1){

    {_ATP_LINE_OFFSET_RETURN(1,2);{_ATC_PROC(1,4); /* return */ {_ATL_STACK_OUT_EXPR_TYPE_START(int)( a * b); _ATQ_OUT  _ATT_OUT  _ATL_STACK_OUT_EXPR_TYPE_END(0);}}}
}}}}}}
