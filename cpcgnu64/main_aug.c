...
# 240 "/usr/include/machine/_default_types.h" 3 4
typedef long int __int_fast16_t;

typedef long unsigned int __uint_fast16_t;
# 262 "/usr/include/machine/_default_types.h" 3 4
typedef long int __int_fast32_t;

typedef long unsigned int __uint_fast32_t;
# 280 "/usr/include/machine/_default_types.h" 3 4
typedef long int __int_fast64_t;

typedef long unsigned int __uint_fast64_t;
# 294 "/usr/include/machine/_default_types.h" 3 4
...
# 325 "/usr/include/machine/_default_types.h" 3 4
...
# 341 "/usr/include/machine/_default_types.h" 3 4
typedef short unsigned int __char16_t;
...
int main() {_ATC_LINK(1);{_ATC_PROC_IN(1,1);{_ATC_BLOC(1,3);{_ATL_STACK_IN3(1,1,11) _ATZ_IN(1)_ATQ_IN3(1,0,11)_ATP_IN(1){_ATT_IN(1){
    ...
    (_ATQ_CALL(1,0,0),(_ATC_CALL(1,0),(_ATP_LINE_OFFSET_EXPR_START(1,4),(printf("Simple Calculator\n")))));
    (_ATQ_CALL(1,1,0),(_ATC_CALL(1,1),(_ATP_LINE_OFFSET_EXPR_START(1,5),(printf("1. Add\n2. Subtract\n")))));
    (_ATQ_CALL(1,2,0),(_ATC_CALL(1,2),(_ATP_LINE_OFFSET_EXPR_START(1,6),(printf("Enter your choice: ")))));
    (_ATQ_CALL(1,3,0),(_ATC_CALL(1,3),(_ATP_LINE_OFFSET_EXPR_START(1,7),(scanf("%d", &choice)))));

    (_ATQ_CALL(1,4,0),(_ATC_CALL(1,4),(_ATP_LINE_OFFSET_EXPR_START(1,9),(printf("Enter two numbers: ")))));
    (_ATQ_CALL(1,5,0),(_ATC_CALL(1,5),(_ATP_LINE_OFFSET_EXPR_START(1,10),(scanf("%d %d", &num1, &num2)))));

    {_ATC_SWITCH;switch (choice) {
        case 1:{_ATC_COND_CASE(1,0);
            _ATC_BLOC(1,0);result = (_ATQ_CALL(1,6,0),(_ATC_CALL(1,6),(_ATP_LINE_OFFSET_EXPR_START(1,14),(add(num1, num2)))));}
            (_ATQ_CALL(1,7,0),(_ATC_CALL(1,7),(_ATP_LINE_OFFSET_EXPR_START(1,15),(printf("Result = %d\n", result)))));
            break;
        case 2:{_ATC_COND_CASE(1,1);
